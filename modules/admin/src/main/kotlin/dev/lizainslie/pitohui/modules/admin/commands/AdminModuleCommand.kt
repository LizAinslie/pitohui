...
import dev.lizainslie.moeka.core.commands.BaseCommandDsl
...
import dev.lizainslie.moeka.core.modules.ModuleSource
import dev.lizainslie.moeka.platforms.discord.Discord

internal fun BaseCommandDsl.defineModuleNameArg() =
    argument("module_name", "The name of the module to reload", ArgumentTypes.STRING) {
        defaultValue = "all"
