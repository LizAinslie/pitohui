...
import dev.lizainslie.moeka.util.color.hexString
...
val GreetingModuleConfigCommand =
    defineCommand(
        "greeting_config",
        ...
        subCommand(
            ...
            val channelArg =
                argument("channel", "The channel that welcome messages will be sent to", ArgumentTypes.CHANNEL) {
                    required = true
                }
            val messageArg =
                argument(
                    "message",
                    "The content of the welcome message (you can reference {variables} which will be replaced)",
                    ArgumentTypes.STRING,
                ) {
                    required = true
                }
            val embedArg =
                argument("embed", "If enabled, the welcome message will be placed inside of an embed", ArgumentTypes.BOOLEAN) {
                    required = true
                }
            val colorArg =
                argument("color", "The color of the embed (if embed is enabled)", ArgumentTypes.COLOR) {
                    required = true
                }
            val imageArg =
                argument("image", "The URL of an image that will be attached with the welcome message", ArgumentTypes.STRING) {
                    required = true
                }
        ...
        subCommand(
            ...
            val userArg =
                argument("user", "The user to test the greeting welcome message for", ArgumentTypes.USER) {
                    required = true
                }
        ...
        subCommand(
            ...
            val channelArg =
                argument("channel", "The channel that goodbye messages will be sent to", ArgumentTypes.CHANNEL) {
                    required = true
                }
            val messageArg =
                argument(
                    "message",
                    "The content of the goodbye message (you can reference {variables} which will be replaced)",
                    ArgumentTypes.STRING,
                ) {
                    required = true
                }
            val embedArg =
                argument("embed", "If enabled, the goodbye message will be placed inside of an embed", ArgumentTypes.BOOLEAN) {
                    required = true
                }
            val colorArg =
                argument("color", "The color of the embed (if embed is enabled)", ArgumentTypes.COLOR) {
            ...
            val imageArg =
                argument("image", "The URL of an image that will be attached with the goodbye message", ArgumentTypes.STRING) {
                    required = true
                }
        ...
        subCommand(
            ...
            val userArg =
                argument("user", "The user to test the greeting goodbye message for", ArgumentTypes.USER) {
                    required = true
                }
