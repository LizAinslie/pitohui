...
import dev.lizainslie.moeka.util.task.startRepeatingTask
...
object VcDisconnectModule : AbstractModule(
    ...
    fun changeChannelInDisconnectTimer(
        communityId: PlatformId,
        userId: PlatformId,
        newChannelId: PlatformId,
    ) {
